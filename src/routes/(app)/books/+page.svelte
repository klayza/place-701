<script>
	...
	let output = `   <p class=" text-md sm:text-xl">I love to read, and have just begun to read regularly. My goal is to read two books a month. I have setup a deal with family to pay them $100 for every book I fail to complete.</p>	${failed ? fail : ""}`;
...
<div class="max-w-screen-lg m-auto text-lg p-2 py-12 sm:py-16 sm:p-8">
	...
	<div class="md-output all-initial text-md sm:text-xl mt-20">{@html marked(text)}</div>
</div>
