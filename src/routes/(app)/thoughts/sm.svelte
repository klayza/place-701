<script>
  ...
  function calculateWeeks(hours, special=null) {
    ...
    return Math.round((hours * 7 * 52) / 24) - subtractor;
  }
  ...
  <p class="mb-4">Below is your entire life in weeks. Each box represents 1 week. Assuming the average lifespan of 70 years, everyone starts off with 3,640 weeks to do as they please. However, we are becoming more and more distracted in a world where attention is as valuable as gold, so it's easy to lose track.</p>
