<script>
	...
	function addExpandButtons(articleHtml) {
		...
		blockquotes.forEach((blockquote, index) => {
			...
			button.innerHTML = `
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24" class="icon-md m-2 text-token-text-primary rounded bg-black">
...
<div class="max-w-5xl m-auto text-md sm:text-lg py-12 sm:py-12 cursor-default">
